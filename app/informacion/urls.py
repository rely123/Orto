...
from app.informacion.views import EstadoGeneral_crear,EstadoGeneralList,EstadoGeneral_edit,EstadoGeneral_consultar,DatosGeneral_crear,DatosGeneralesList
